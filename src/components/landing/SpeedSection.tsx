...
const STEPS = [
  {
    ...
    emoji: '📱',
    title: 'Open the app',
    desc: 'Launch WorkWala and pick exactly the service you need — in seconds.',
  ...
  },
  {
    ...
    desc: 'WorkWala finds the nearest verified partner — average match time under 2 minutes.',
    color: '#2563EB',
    bg: '#EFF6FF',
    border: '#BFDBFE',
  },
