 ...
 * Fetch all notifications for the authenticated partner
 */
export async function GET(req: NextRequest) {
  try {
    ...
    // for this partner (recipient_type='partner' AND recipient_id=partnerId)
    const rows = await query<RowDataPacket[]>(
      ...
      WHERE pnl.recipient_type = 'partner'
