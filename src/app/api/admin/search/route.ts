...
const NAV_ITEMS: SearchResult[] = [
  ...
  { id: 'nav-partners',      type: 'nav', title: 'Partners',      subtitle: 'Manage service partners',   href: '/admin/partners' },
  { id: 'nav-customers',     type: 'nav', title: 'Customers',     subtitle: 'Manage app customers',      href: '/admin/customers' },
  { id: 'nav-withdrawals',   type: 'nav', title: 'Withdrawals',   subtitle: 'Partner withdrawal requests', href: '/admin/withdrawals' },
