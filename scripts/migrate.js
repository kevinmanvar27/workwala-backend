...
async function migrate() {
  ...
  try {
    ...
    `);
    console.log('✅ Table: call_sessions');
    ...
    `);
    console.log('✅ Table: call_metrics');
    ...
    `);
    console.log('✅ Table: turn_config');

    // Seed default TURN configurations
    await connection.query(`
    ...
    `);
    console.log('✅ Seeded: turn_config');
